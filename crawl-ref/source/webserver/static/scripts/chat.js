define(["jquery", "comm", "linkify"], function ($, comm, linkify) {
    ...
    function update_spectators(data)
    {
        ...
        $("#spectator_count").html("관전자 " + data.count + "명");
    ...
    {
        var press_key = new_message_count > 0 ? " (F12 누르기)" : "";
        $("#message_count").html("새 메시지 " + new_message_count + "개" + press_key);
